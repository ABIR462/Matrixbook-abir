      ...
      <div className="relative flex flex-col items-center gap-6 animate-fade-up">
        <div className="relative">
          ...
          <img
            ...
            width={120}
            height={120}
            className="relative w-28 h-28 object-contain drop-shadow-[0_0_30px_hsl(243_75%_59%/0.6)] animate-pulse"
          />
        </div>
        <div className="text-center">
          <h1 className="huge-type !text-5xl md:!text-6xl glossy-text leading-none">
            MATRIXBOOK
          </h1>
          <p className="font-mono text-[10px] md:text-xs text-neutral-500 mt-3 tracking-[0.3em] uppercase">
            Multimodal Intelligence // Reimagined
          </p>
        </div>
